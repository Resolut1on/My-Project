...
class Event extends EventBase
{
    ...
    private $packetArr = array(
        1 => array("actionId" => 10195, "name"=>"普通礼包", "mpId"=>"MA20150821151156010", "action"=>"get", "object" => "common_packet"),
        2 => array("actionId" => 10196, "name"=>"特权礼包", "mpId"=>"MA20150821152137604", "action"=>"take_packet", "object" => "vip_packet")
    );
