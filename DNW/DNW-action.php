...
class Event extends EventBase
{
    ...
    //活动充值标识
    private $eventAid = "pc_event_dwm201507";
    //actionId、action、object活动后台配置
    private $packetArr = array(
        1 => array("actionId" => 10177, "name"=>"新手礼包", "mpId"=>"MA20150717145808808", "action"=>"get", "object" => "common_packet"),
        2 => array("actionId" => 10178, "name"=>"特权礼包", "mpId"=>"MA20150717150102695", "action"=>"take_packet", "object" => "vip_packet")
    );
