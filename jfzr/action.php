...
{
    //活动后台配置，用于统计分析
    private $eventId = 1059;
    protected $uin = 0;
    protected $nickname = "";
    private $regDateTime = "2015-06-15";
    //活动变更修改项开始(js文件和礼包发送文件都得修改)
    private $startDateTime = "2015-06-15 00:00:00";
    private $endDateTime = "2015-09-15 23:59:59";
    //活动充值标识
    private $eventAid = "pc_event_jfzr201509";
    //actionId、action、object活动后台配置
    private $packetArr = array(
        1 => array("actionId" => 10219, "name"=>"新手礼包", "mpId"=>"", "maxNum" => 150000,"action"=>"get", "object" => "common_packet"),
        2 => array("actionId" => 10220, "name"=>"豪华特权礼包", "mpId"=>"", "maxNum" => 4500,"action"=>"vip_get", "object" => "vip_packet")
    );
    ...
    protected function getCommonPacket()
    {
        ...
        $rsArr = $this->getTGameInfo(120004, $uin, $areaArr[0]["area_id"]);
